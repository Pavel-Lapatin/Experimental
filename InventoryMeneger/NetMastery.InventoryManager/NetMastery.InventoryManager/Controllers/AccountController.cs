...
namespace NetMastery.InventoryManager.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl, bool rememberMe)
        {
            ...
            if (!await _userService.HasBeenVerifiedAsync())
            {
                return View("Error");
            }
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            var result = await _userService.TwoFactorSignInAsync(model.Provider, model.Code, isPersistent: model.RememberMe, rememberBrowser: model.RememberBrowser);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var res = await _userService.Register(user, model.Password);
                if (res.Succeeded)
                {
       ...
       //     }
       //     var result = await _userService.ResetPasswordAsync(user.Id, model.Password);
       //     if (result.Succeeded)
       //     {
       //         return RedirectToAction("ResetPasswordConfirmation", "Account");
       //     }
